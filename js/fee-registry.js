const FEE_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    aliases:['avs fee','address verification fee','address verification service fee','addrs verification service fee'], frequency:'per_transaction', negotiable:true, published:false,
    patterns:[/\bavs fee\b/i,/\baddr(?:ess|s) verification(?: service)? fee\b/i], ruleId:'FT-0010'
  },
  {
...
},
{
  ...
  standardName:'Processor Sales Discount Markup',
  category:'processor_markup',
  subcategory:'discount_rate_markup',
  bucket:'processor_revenue',
  aliases:['mastercard debit sales disc','mastercard sales discount','visa sales discount','visa debit sales discount','discover sales discount','amex sales discount'],
  frequency:'volume_based',
  negotiable:true,
  published:false,
  patterns:[/\b(?:mastercard|visa|discover|amex)(?: debit)? sales disc(?:ount)?\b/i],
  ruleId:'CC-FT-0002'
},
{
  id:'CCF-CC-0002',
  processorScope:'Commerce Control',
  standardName:'CardPointe Platform Fee',
  category:'third_party_service',
  subcategory:'payment_platform',
  bucket:'third_party',
  aliases:['cardpointe platform fee'],
  frequency:'monthly',
  negotiable:true,
  published:false,
  patterns:[/\bcardpointe platform fee\b/i],
  ruleId:'CC-FT-0003'
},
{
  id:'CCF-CC-0003',
  processorScope:'Commerce Control',
  standardName:'General Debit Transaction Fee',
  category:'processor_transaction_fee',
  subcategory:'debit_transaction',
  bucket:'processor_revenue',
  aliases:['gen debit transaction fee','general debit transaction fee'],
  frequency:'per_transaction',
  negotiable:true,
  published:false,
  patterns:[/\bgen\.? debit transaction fee\b/i],
  ruleId:'CC-FT-0004'
},
{
  id:'CCF-CC-0004',
  processorScope:'Commerce Control',
  standardName:'Online Debit Denial Fee',
  category:'processor_transaction_fee',
  subcategory:'debit_denial',
  bucket:'processor_revenue',
  aliases:['online debit denial','online debit denial fee'],
  frequency:'per_occurrence',
  negotiable:true,
  published:false,
  patterns:[/\bonline debit denial(?: fee)?\b/i],
  ruleId:'CC-FT-0005'
},
{
  id:'CCF-CC-0005',
  processorScope:'Commerce Control',
  standardName:'Regulatory Product Fee',
  category:'compliance',
  subcategory:'regulatory_product',
  bucket:'processor_revenue',
  aliases:['regulatory product fee'],
  frequency:'monthly',
  negotiable:true,
  published:false,
  patterns:[/\bregulatory product fee\b/i],
  ruleId:'CC-FT-0006'
},
{
  id:'CCF-CC-1001',
  processorScope:'Commerce Control',
  standardName:'Mastercard Connectivity Fee',
  category:'assessment',
  subcategory:'network_connectivity_fee',
  bucket:'network',
  brand:'Mastercard',
  aliases:['mc auth connectivity fee','mc clearing connectivity fee'],
  frequency:'usage_based',
  negotiable:false,
  published:true,
  patterns:[/\bmc (?:auth|clearing) connectivity fee\b/i],
  ruleId:'CC-FT-1001'
},
{
  id:'CCF-CC-1002',
  processorScope:'Commerce Control',
  standardName:'Discover Data Usage Fee',
  category:'assessment',
  subcategory:'network_data_usage_fee',
  bucket:'network',
  brand:'Discover',
  ...
  negotiable:false,
  published:true,
  patterns:[/\bdiscover data usage fee\b/i],
  ruleId:'CC-FT-1002'
},
{
  id:'CCF-CC-1003',
  processorScope:'Commerce Control',
  standardName:'Visa Base II Network Fee',
  category:'assessment',
  subcategory:'network_processing_fee',
  bucket:'network',
  brand:'Visa',
  aliases:['vi base ii cr vcher fee us cr','vi base ii cr vcher fee us d p','vi base ii system file fee'],
  frequency:'per_transaction',
  negotiable:false,
  published:true,
  patterns:[/\bvi base ii (?:cr vcher|system file) fee\b/i],
  ruleId:'CC-FT-1003'
},
{
  id:'CCF-CC-1004',
  processorScope:'Commerce Control',
  standardName:'Discover Digital Investment Fee',
  category:'assessment',
  subcategory:'network_program_fee',
  bucket:'network',
  brand:'Discover',
  aliases:['digital investment fee'],
  frequency:'volume_based',
  negotiable:false,
  published:true,
  patterns:[/\bdigital investment fee\b/i],
  ruleId:'CC-FT-1004'
},
{
  id:'CCF-CC-1005',
  processorScope:'Commerce Control',
  standardName:'Visa Commercial Solutions Fee',
  category:'assessment',
  subcategory:'network_program_fee',
  bucket:'network',
  brand:'Visa',
  aliases:['vi commercial solutions fee'],
  frequency:'transaction_or_volume_based',
  negotiable:false,
  published:true,
  patterns:[/\bvi-commercial solutions fee\b/i,/\bvi commercial solutions fee\b/i],
  ruleId:'CC-FT-1005'
},
{
  id:'CCF-CC-1006',
  processorScope:'Commerce Control',
  standardName:'Mastercard Monthly Location Fee',
  category:'assessment',
  subcategory:'network_location_fee',
  bucket:'network',
  brand:'Mastercard',
  aliases:['mc monthly location fee'],
  frequency:'monthly',
  negotiable:false,
  published:true,
  patterns:[/\bmc monthly location fee\b/i],
  ruleId:'CC-FT-1006'
},
{
  id:'CCF-CC-1007',
  processorScope:'Commerce Control',
  standardName:'Visa Network Fee',
  category:'assessment',
  subcategory:'network_fixed_fee',
  bucket:'network',
  brand:'Visa',
  aliases:['visa network fee cp 1b 01'],
  frequency:'monthly',
  negotiable:false,
  published:true,
